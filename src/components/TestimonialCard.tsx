    ...
    <Card className="h-full">
      <CardContent className="flex flex-col space-y-4 pt-6">
        <div className="relative">
          <svg className="absolute top-0 left-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-200 dark:text-gray-700" 
               width="16" 
               height="16" 
               viewBox="0 0 16 16" 
               fill="none" 
